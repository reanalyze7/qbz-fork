//! Slice 6 (check step) — install/package-name commands and the reference
//! setup commands shown when the host can't be probed (sandbox).

use qbz_audio::{Distro, InitSystem};

use super::remediation::restart_cmd;
